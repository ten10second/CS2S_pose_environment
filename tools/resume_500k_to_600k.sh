#!/usr/bin/env bash
# Resume the 500k single-frame run to 600k steps on 4 GPUs, mirroring run_args.json exactly.
set -euo pipefail
...
RUN=/mnt/shizhm/DATA/KITTI/CS2S_results/kitti_ray_posterior/ray_posterior_utonia_dino_sd14_4gpu_20260812
...
exec env \
    ...
    /home/shizhm/miniconda3/envs/ControlS2S/bin/torchrun --nproc_per_node=4 --master_port=29611 tools/train_kitti_raea.py \
    ...
    --run-name ray_posterior_utonia_dino_sd14_4gpu_20260812 \
    --steps 600000 \
    --batch-size 1 \
    --num-workers 2 \
