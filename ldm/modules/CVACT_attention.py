...
from models.geometry.sat2grd import  grid_sample, CVACT_grd2sat_uv_h
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, context=None, mask=None):
        if context == None:
            ...
            reference_points_rebatch, indexes = CVACT_grd2sat_uv_h(int(num_query**(1/2)/2), int(num_query**(1/2)*2), int(feat_size), int(feat_size))
