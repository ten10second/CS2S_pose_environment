...
from models.geometry.VIGOR_sat2grd import VIGOR_sat2grd_uv_h
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, context=None, mask=None):
        if context == None:
            ...
            # meter_per_pixel = torch.ones(1) * 0.11 * 640 / 512 * 256 /  feat_size
            reference_points_rebatch, indexes = VIGOR_sat2grd_uv_h(int(num_query**(1/2)/2), int(num_query**(1/2)*2), int(feat_size), int(feat_size))
